...
import com.samarth.aadhaarscanner.R;
import com.samarth.aadhaarscanner.SavedAadhaarCardActivity;
...
public class CardListAdapter extends ArrayAdapter<ArrayList>{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.aadhaar_card_list,parent,false);
