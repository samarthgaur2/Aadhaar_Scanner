...
public class SecureQrCode{
     ...
     * Samarth2(Samarth2(Email+SharePhrase))*number of times last digit of Aadhaar number
     ...
     * Passcode : Lock@487
     * Hash : Samarth2(Samarth2(abc@gm.comLock@487))*2
     * In case of Aadhaar number ends with Zero we will hashed one time.
     * **********************************************************************
     * **********************************************************************
     * Hashing logic for Mobile Number :
     * Samarth2(Samarth2(Mobile+SharePhrase))*number of times last digit of Aadhaar number
     * (Ref ID field contains last 4 digits).
     *
     * Example :
     * Mobile: 1234567890
     * Aadhaar Number:XXXX XXXX 3632
     * Passcode : Lock@487
     * Hash: Samarth2(Samarth2(1234567890Lock@487))*2
     * In case of Aadhaar number ends with Zero we will hashed one time.
    ...
    public AadhaarCard getScannedAadharCard(){
